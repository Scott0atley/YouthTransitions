...
simulation.do 				run handling missing data simulation 
...
global fld "G:\Stata data and do\NCDS"
* Folder altered data will be saved in.
global dta_fld "G:\Stata data and do\do files\NCDS\data"
* Folder do files are kept in.
global do_fld "G:\Stata data and do\do files\NCDS\do"
* Set Personal ado folder
sysdir set PLUS "${do_fld}\ado\"
* Folder for outputs
global out_fld "G:\Stata data and do\do files\NCDS\outputs"


* NCDS Folder Prefix for Stata Files
global ncds_path			ncds
...
/*====================================================================
                        2: Create Programs Set Up
====================================================================*/

qui do "${do_fld}/Create Programs.do"	
...
*vi. Run Missing Data Simulation
	qui do "${do_fld}/simulation.do"	
